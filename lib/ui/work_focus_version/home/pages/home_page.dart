                ...
                if (settingsState is GetShareLinkStateSuccessState) {
                  ...
                  if (data.user != null) {
                    ...
                    DIManager.findNavigator().pushNamed(
                        ...
                        arguments: ItemsArgs(
                            id: data!.ad?.ad_id,
                            categoryId: data!.ad?.category_id ?? 0));
                  }
                }
              },
              child: Stack(
                      ...
                      children: [
                        Expanded(
                          ...
                          child: RefreshIndicator(
                            ...
                            backgroundColor:
                                AppColorsController().defaultPrimaryColor,
                            onRefresh: () => Future(() {
                                        ...
                                        Column(
                                          children: [
                                            Row(
                                              children: [
                                                InkWell(
                                                    ...
                                                    child: Icon(Icons.group,size: 40.sp,
                                                    color: AppColorsController().red,)),
                                              ],
                                            ),
                                            BuildItemsWidget(
                                              name: translate(
                                                  "recent_uploaded_items"),
                                              type: 0,
                                            ),
                                            BuildItemsWidget(
                                              name:
                                                  translate("most_rate_items"),
                                              type: 1,
                                            ),
                                            BuildItemsWidget(
                                            ...
                                            BuildItemsWidget(
                                              ...
                                              type: 3,
                                              category_id:
                                                  AppConsts.jobCategoryId,
                                            ),
                                            SizedBox(
                                              height:
                                                  Platform.isIOS ? 15.h : 35.h,
                                            ),
                                          ],
                                        ),
                                      ],
